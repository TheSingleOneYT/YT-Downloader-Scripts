...
:: More/newer versions of this batch may be available at https://github.com/TheSingleOneYT/YT-Downloader-Scripts/tree/main/Batch
...
echo 2) Install Microsoft Visual C++ 2010 x86 Redistributable (https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x86.exe)
echo 3) Run this Batch File again and type 2. Then, on the next prompt, paste the YT video URL.
echo 4) It should now begin downloading the video, wait and enjoy!
